...
public class ReminderSQLiteHelper extends SQLiteOpenHelper {
	...
	/***
	 * 
	 * Get THE DETAILS * LECTURES
	 * 
	 */
	
public List<Reminder> getAllLECTURES() {
	...
	/***
	 * 
	 * Get THE DETAILS * Holiday
	 * 
	 */

public List<Reminder> getAllHoliday() {
	...
	// select book query
	String holidays ="holiday";
	String query = "SELECT  * FROM " + table_BOOKS + "Where"+ Reminder_Type +"=" +holidays;
	//String query = "SELECT  * FROM " + table_BOOKS;
	// get reference of the BookDB database
	SQLiteDatabase db = this.getWritableDatabase();
	Cursor cursor = db.rawQuery(query, null);
...
///////////////////////////////////
	...
	/***
	 * 
	 * Get THE DETAILS * Todo
	 * 
	 */
	
public List<Reminder> getTodo() {
	...
	String todo = "todo";
	//String query = "SELECT  * FROM " + table_BOOKS;
	//String query = "SELECT  * FROM " + table_BOOKS + "Where Reminder_Type = '" +todo;
	String query = "SELECT  * FROM " + table_BOOKS;
	// get reference of the BookDB database
	SQLiteDatabase db = this.getWritableDatabase();
	Cursor cursor = db.rawQuery(query, null);
...
////////////////////////////////////
	/***
	 * 
	 * Get THE DETAILS * Exams
	 * 
	 */

public List<Reminder> getAllExams() {
	...
	// select book query
	String exams = "exams";
	//String query = "SELECT  * FROM " + table_BOOKS + "Where Reminder_Type = '"+exams;
	String query = "SELECT  * FROM " + table_BOOKS;
	// get reference of the BookDB database
	SQLiteDatabase db = this.getWritableDatabase();
	Cursor cursor = db.rawQuery(query, null);
...
////////////////////////////////////
	...
	/***
	 * 
	 * Get THE DETAILS * Home work
	 * 
	 */
public List<Reminder> getHomework() {
	...
	///String query = "SELECT  * FROM " + table_BOOKS + "Where Reminder_Type = '"+homework;
	String query = "SELECT  * FROM " + table_BOOKS;
	// get reference of the BookDB database
	SQLiteDatabase db = this.getWritableDatabase();
	Cursor cursor = db.rawQuery(query, null);
